...
+
A chat widget to appears. You can start a conversation with a ThoughtSpot Sales representative to initiate the upgrade.
* To evaluate ThoughtSpot Everywhere features, click **Try for free**.
+
A 30-day free trial is activated on your cluster. You can upgrade your license at any time during the trial period, or when the trial expires, by clicking **Upgrade now**. 
